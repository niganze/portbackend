...
exports.updateProject = exports.getProjectById = exports.getAllProjects = exports.deleteProject = exports.createProject = void 0;
...
var createProject = exports.createProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, title, description, image, techStack, project, savedProject;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, title = _req$body.title, description = _req$body.description, image = _req$body.image, techStack = _req$body.techStack;
...
var getAllProjects = exports.getAllProjects = /*#__PURE__*/function () {
  ...
  return function getAllProjects(_x3, _x4) {
...
var updateProject = exports.updateProject = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, title, description, image, techStack, project, updatedProject;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, title = _req$body2.title, description = _req$body2.description, image = _req$body2.image, techStack = _req$body2.techStack;
          _context4.prev = 1;
          _context4.next = 4;
          return _Project["default"].findById(req.params.id);
        case 4:
